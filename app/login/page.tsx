...
import { Mountain, ArrowLeft, Lock, Mail, ShieldAlert } from "lucide-react";
            ...
            <div className="relative z-20 w-full max-w-md rounded-2xl border border-white/15 bg-slate-900/80 p-8 sm:p-10 shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <p className="mt-1.5 text-xs sm:text-sm text-slate-400 max-w-xs">
                        Sign in to access the Landslide Early Warning System.
                    </p>
                </div>
                ...
                {message && (
                    <div className="mt-5 rounded-xl border border-rose-500/30 bg-rose-500/10 p-3.5 text-xs text-rose-300 flex items-start gap-2.5">
